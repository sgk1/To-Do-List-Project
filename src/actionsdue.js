    ...
    function renderTodoList(selectedProject = null) {
        ...
        const filteredTodoList = todoList
            .filter(todo => {
                ...
                // if no project selected, filter by todos that are due in the past
                const today = getTodayDate();
                return todo.date < today && todo.date; // todo.date included to filter out todos without due date
            })
            .sort((a,b) => {
